...
models = "/home/rj/Downloads/Super-Resolution-in-OpenCV/Models"
path = "ESPCN_x2.pb"
# path = "FSRCNN-small_x2.pb"
# path = "FSRCNN_x2.pb"

sr.readModel(f"{models}/{path}")
sr.setModel("espcn", 2)  # set the model and scale to 2x
# sr.setModel("fsrcnn", 2)  # set the model and scale to 2x
# sr.setModel("fsrcnn", 2)  # set the model and scale to 2x
...
def record_video(cam_index=0):
    ...
    while True:  # Loop until 'q' is pressed
        ...
        # upscale the frame using super resolution
